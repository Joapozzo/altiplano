                        ...
                        <div className={`bg-white/90 backdrop-blur-sm rounded-xl shadow-xl border ${colors.border} p-8 relative overflow-hidden group hover:shadow-2xl transition-all duration-500`}>
                            ...
                            <div className="max-w-2xl mx-auto relative z-10">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <AnimatedButton className={`${colors.button} text-white px-8 py-3 rounded-xl transition-all duration-300 font-bold w-full sm:w-auto transform hover:scale-105 hover:shadow-lg group/btn`} onClick={() => openWhatsApp()}>
